...
---
# <a name="migrate-from-aspnet-web-forms-to-blazor"></a>Переход с веб-форм ASP.NET наBlazor
...
- Возможность запуска от имениWebAssembly
...
### <a name="model-validation-in-blazor"></a>Проверка модели вBlazor
