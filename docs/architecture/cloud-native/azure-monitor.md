...
![Azure Monitor, коллекция для инструментов, позволяющая получить представление о работе облачного приложения. ](./media/azure-monitor.png)
...
![Результат Application Insights запроса на ](./media/azure-monitor.png)
...
![Пример Application Insights диаграмм, внедренных на главную панель мониторинга Azure ](./media/azure-monitor.png)
...
![Пример Power BI панели мониторинга ](./media/azure-monitor.png)
