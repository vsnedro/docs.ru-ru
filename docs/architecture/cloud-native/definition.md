...
ms.locfileid: "80989094"
---
# <a name="defining-cloud-native"></a>Определение родного облака

[!INCLUDE [book-preview](../../../includes/book-preview.md)]

Остановите то, что вы делаете, и напишите десять ваших коллег. Попросите их определить термин "Облако родной". Хороший шанс, что вы получите восемь разных ответов.
