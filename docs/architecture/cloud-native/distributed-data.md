...
ms.locfileid: "91163938"
---
# <a name="distributed-data"></a>Распределенные данные
...
Во многих случаях единая база данных обеспечивает простоту управления данными. Запрос данных по нескольким таблицам прост. Изменения в данных обновляются вместе или во всех операциях отката. [Транзакции ACID](/windows/desktop/cossdk/acid-properties) гарантируют строгую и немедленную согласованность.
...
## <a name="database-per-microservice-why"></a>Зачем нужна база данных для микрослужбы?
...
Вместо этого широко принятым шаблоном для удаления зависимостей между службами является [Материализованный шаблон представления](/azure/architecture/patterns/materialized-view), показанный на рис. 5-4.
...
[CQRS](/azure/architecture/patterns/cqrs)— это шаблон архитектуры, позволяющий максимально повысить производительность, масштабируемость и безопасность. Шаблон разделяет операции, считывающие данные из операций, которые записывают данные.
