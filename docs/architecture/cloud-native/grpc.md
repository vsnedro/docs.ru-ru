...
Используя файл с таким же параметром, компилятор `protoc`protobuf создает как клиентский, так и код службы для целевой платформы. Код включает следующие компоненты:
