...
![Ведение журнала в файл в монолитном приложении. ](./media/single-monolith-logging.png)
...
![Ведение журнала для файлов в масштабируемом монолитном приложении. ](./media/multiple-node-monolith-logging.png)
