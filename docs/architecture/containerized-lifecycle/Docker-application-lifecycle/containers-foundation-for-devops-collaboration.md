...
## <a name="challenges-in-the-application-life-cycle-when-using-docker"></a>Трудности, связанные с использованием технологии Docker в рамках жизненного цикла приложений.
