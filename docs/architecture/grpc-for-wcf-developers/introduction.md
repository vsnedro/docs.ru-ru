...
Это руководством было написано для разработчиков, работающих в .NET Framework или .NET Core, которые использовали WCF и которым требуется перенести свои приложения в современное окружение RPC для .NET Core 3,0 и более поздних версий. Это средство также может оказаться полезным для разработчиков, обновляющих или использующих обновление до .NET и желающих использовать встроенные средства gRPC.
