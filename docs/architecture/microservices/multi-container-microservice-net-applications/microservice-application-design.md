...
### <a name="eshoponcontainers-a-reference-application-for-net-and-microservices-deployed-using-containers"></a>eShopOnContainers: эталонное приложение для .NET и микрослужб, развернутых с использованием контейнеров
...
Вы также можете создавать микрослужбы с помощью множества технологий и языков, таких как веб-API ASP.NET Core, NancyFx, SignalR ASP.NET Core (доступный в .NET Core 2 и более поздних версий), F\#, Node.js, Python, Java, C++, GoLang и многих других.
