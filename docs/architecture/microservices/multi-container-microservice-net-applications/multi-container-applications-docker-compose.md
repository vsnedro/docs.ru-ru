...
Команда разработчиков .NET предоставляет в [dotnet/core](https://hub.docker.com/_/microsoft-dotnet/) (в Docker Hub) четыре основных варианта:
