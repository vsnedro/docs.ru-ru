...
Начиная с версии .NET Core 2.1, все образы .NET Core, в том числе для ASP.NET Core, можно найти в репозитории образов .NET Core на сайте Docker Hub: <https://hub.docker.com/_/microsoft-dotnet/>.
...
| Образ — | Комментарии |
|-------|----------|
| mcr.microsoft.com/dotnet/aspnet:**3.1** | ASP.NET Core только со средой выполнения и оптимизацией ASP.NET Core в Linux и Windows (для разных архитектур) |
| mcr.microsoft.com/dotnet/sdk:**3.1** | .NET Core с пакетами SDK в Linux и Windows (для разных архитектур) |
