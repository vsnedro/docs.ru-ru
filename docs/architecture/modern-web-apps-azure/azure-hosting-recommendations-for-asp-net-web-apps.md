...
[Ознакомьтесь с дополнительными сведениями о моделях разработки, которые следует учитывать при создании систем на базе микрослужб.](/azure/architecture/microservices/design/patterns)
...
[Дополнительные сведения об Azure DevOps](/azure/dev-spaces/about)
