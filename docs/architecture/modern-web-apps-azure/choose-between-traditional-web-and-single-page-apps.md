...
Если у вас есть приложение с веб-формами, которое предполагается перенести в .NET Core, можно ознакомиться с бесплатной электронной книгой, [Blazor для разработчиков веб-форм](../blazor-for-web-forms-developers/index.md), чтобы узнать, имеет ли смысл переходить на Blazor.
