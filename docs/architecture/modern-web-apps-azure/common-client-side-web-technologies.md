...
> [!NOTE]
> Blazor предоставляет альтернативу платформам JavaScript для создания многофункциональных интерактивных пользовательских интерфейсов клиента. Поддержка Blazor на стороне клиента по-прежнему находится на этапе предварительной версии, поэтому теперь она выходит за рамки этой главы.
