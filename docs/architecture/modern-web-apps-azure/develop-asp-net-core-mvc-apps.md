...
- Проверка подлинности. Используйте сведения, предоставленные клиентом, чтобы создать для него удостоверение для использования в приложении.
