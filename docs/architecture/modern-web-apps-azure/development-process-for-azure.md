...
[Определение процесса сборки в рамках процесса непрерывной интеграции](https://docs.microsoft.com/azure/devops/pipelines/ecosystems/dotnet-core)
...
[Развертывание веб-приложения Azure](https://docs.microsoft.com/azure/devops/pipelines/targets/webapp)
