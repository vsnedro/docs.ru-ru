...
- Использование службы [Analytics](/azure/application-insights/app-insights-analytics) для поиска, запроса и создания пользовательских диаграмм по данным функции.
...
Следующий код измеряет, сколько времени требуется для вставки новой строки в экземпляр [Хранилища таблиц Azure](/azure/cosmos-db/table-storage-overview):
...
Дополнительные сведения см. в разделе [Мониторинг функций Azure](/azure/azure-functions/functions-monitoring).
