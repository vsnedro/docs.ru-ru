...
Дополнительные сведения см. в статье [Windows N-tier application on Azure with SQL Server](/azure/architecture/reference-architectures/virtual-machines-windows/n-tier) (Использование n-уровневого приложения с SQL Server в Azure).
...
Дополнительные сведения о виртуальных машинах см. на [этой странице](/azure/virtual-machines/).
...
Дополнительные сведения о SaaS см. в статье [The Wingtip Tickets SaaS application](/azure/sql-database/saas-tenancy-welcome-wingtip-tickets-app) (Приложение SaaS Wingtip Tickets).
...
Дополнительные сведения об оркестрации см. в статье [Служба Azure Kubernetes (AKS)](/azure/aks/intro-kubernetes).
...
- [Руководство по архитектуре приложений Azure](/azure/architecture/guide/)
- [Azure Cosmos DB](/azure/cosmos-db)
- [Azure SQL;](/azure/sql-database)
- [N-tier architecture style](/azure/architecture/guide/architecture-styles/n-tier) (N-уровневый стиль архитектуры)
- [Kubernetes в Azure](/azure/aks/intro-kubernetes)
- [Микрослужбы](/azure/architecture/guide/architecture-styles/microservices)
- [Windows N-tier application on Azure with SQL Server](/azure/architecture/reference-architectures/virtual-machines-windows/n-tier) (Использование n-уровневого приложения Windows с SQL Server в Azure)
- [Виртуальные машины](/azure/virtual-machines/)
- [Что такое Docker?](../microservices/container-docker-introduction/docker-defined.md)
- [The Wingtip Tickets SaaS application](/azure/sql-database/saas-tenancy-welcome-wingtip-tickets-app) (Приложение SaaS Wingtip Tickets)
