...
&copy; Корпорация Майкрософт (Microsoft Corporation), 2018–2020
...
> **[Джереми Ликнесс (Jeremy Likness)](https://twitter.com/jeremylikness)** , старший руководитель программы по данным .NET, корпорация Майкрософт.
...
В этом руководстве описаны архитектурные подходы и конструктивные шаблоны и не рассматриваются детали реализации функций Azure, [Logic Apps](/azure/logic-apps/logic-apps-what-are-logic-apps) или других бессерверных платформ. В данном руководстве, например, не рассматриваются, расширенные рабочие процессы с Logic Apps или возможности функций Azure, такие как настройка общего доступа к ресурсам независимо от источника (CORS), применение личных доменов и передача SSL-сертификатов. Эти сведения доступны в онлайн-документации по [функциям Azure](/azure/azure-functions/functions-reference).

### <a name="additional-resources"></a>Дополнительные ресурсы

- [Центр архитектуры Azure](/azure/architecture/)
- [Советы и рекомендации для облачных приложений](/azure/architecture/best-practices/api-design)
