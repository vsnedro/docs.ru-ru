...
- обработка данных о состоянии с помощью обработчика рабочих процессов, такого как [устойчивые функции](/azure/azure-functions/durable/durable-functions-overview).
