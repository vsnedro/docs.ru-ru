...
- обработка данных о состоянии с помощью обработчика рабочих процессов, такого как [устойчивые функции](https://docs.microsoft.com/azure/azure-functions/durable/durable-functions-overview).
