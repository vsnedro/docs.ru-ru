...
В этом документе содержится обзор ключевых концепций и услуг .NET, с которых разработчики должны быть знакомы, чтобы начать разработку приложений с помощью служб Azure.
...
* [Развертывание первого веб-приложения ASP.NET Core в Azure](https://docs.microsoft.com/azure/app-service/app-service-web-get-started-dotnet)
* [Узнайте больше о проверке подлинности в Azure SDK для .NET](./sdk/authentication.md)
