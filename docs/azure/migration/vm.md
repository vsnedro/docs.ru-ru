...
- Создайте виртуальную машину в Azure для приложения ASP.NET, используя один из следующих вариантов:
  ...
  - [Перенос существующей локальной виртуальной машины VMware](https://docs.microsoft.com/azure/migrate/tutorial-migrate-vmware).
  - [Перенос существующей локальной виртуальной машины Hyper-V](https://docs.microsoft.com/azure/migrate/tutorial-migrate-hyper-v).
