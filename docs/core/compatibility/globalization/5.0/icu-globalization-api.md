...
description: Сведения о критическом изменении глобализации в .NET 5.0, где для функций глобализации используются библиотеки ICU вместо NLS.
ms.date: 05/19/2020
