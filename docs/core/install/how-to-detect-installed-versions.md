...
- [Установка среды выполнения .NET и пакета SDK для macOS](macos.md).
- [Установка среды выполнения .NET и пакета SDK для Linux](linux.md).

## <a name="see-also"></a>См. также раздел

- [Определение установленных версий платформы .NET Framework](../../framework/migration-guide/how-to-determine-which-versions-are-installed.md)
