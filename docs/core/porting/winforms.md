...
- [Visual Studio 2019 версии 16.5 или более поздней](https://visualstudio.microsoft.com/thank-you-downloading-visual-studio/?sku=community&rel=16) для выполнения задач по конструированию. Рекомендуется выполнить обновление до [последней версии Visual Studio](https://visualstudio.microsoft.com/vs/).
...
> [!NOTE]
> Проекты Windows Forms .NET Core поддерживаются в Visual Studio 2019 и более поздних версиях. Конструктор Windows Forms .NET Core поддерживается в Visual Studio 2019, начиная с версии 16.5.
>
