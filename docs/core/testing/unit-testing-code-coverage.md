...
> Можно ознакомиться с [руководством по интеграции MSBuild](https://github.com/coverlet-coverage/coverlet/blob/master/Documentation/MSBuildIntegration.md)
