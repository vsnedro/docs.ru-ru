...
| <span data-ttu-id="e3d91-212">Серверное приложение Blazor</span><span class="sxs-lookup"><span data-stu-id="e3d91-212">Blazor Server App</span></span>                            | [<span data-ttu-id="e3d91-213">blazorserver</span><span class="sxs-lookup"><span data-stu-id="e3d91-213">blazorserver</span></span>](#blazorserver)   | <span data-ttu-id="e3d91-214">[C#]</span><span class="sxs-lookup"><span data-stu-id="e3d91-214">[C#]</span></span>         | <span data-ttu-id="e3d91-215">Веб/Blazor</span><span class="sxs-lookup"><span data-stu-id="e3d91-215">Web/Blazor</span></span>                            | <span data-ttu-id="e3d91-216">3.0</span><span class="sxs-lookup"><span data-stu-id="e3d91-216">3.0</span></span>        |
| <span data-ttu-id="e3d91-217">Приложение WebAssembly Blazor</span><span class="sxs-lookup"><span data-stu-id="e3d91-217">Blazor WebAssembly App</span></span>                       | [<span data-ttu-id="e3d91-218">blazorwasm</span><span class="sxs-lookup"><span data-stu-id="e3d91-218">blazorwasm</span></span>](#blazorwasm)       | <span data-ttu-id="e3d91-219">[C#]</span><span class="sxs-lookup"><span data-stu-id="e3d91-219">[C#]</span></span>         | <span data-ttu-id="e3d91-220">Веб/Blazor/WebAssembly</span><span class="sxs-lookup"><span data-stu-id="e3d91-220">Web/Blazor/WebAssembly</span></span>                | <span data-ttu-id="e3d91-221">3.1.300</span><span class="sxs-lookup"><span data-stu-id="e3d91-221">3.1.300</span></span>    |
...
- **`-ho|--hosted`**
  ...
  <span data-ttu-id="e3d91-475">Включает узел ASP.NET Core для приложения Blazor WebAssembly.</span><span class="sxs-lookup"><span data-stu-id="e3d91-475">Includes an ASP.NET Core host for the Blazor WebAssembly app.</span></span>
