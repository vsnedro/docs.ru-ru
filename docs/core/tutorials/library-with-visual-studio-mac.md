...
---
# <a name="tutorial-create-a-net-class-library-using-visual-studio-for-mac"></a>Учебник. Создание библиотеки классов .NET с помощью Visual Studio для Mac
...
1. В диалоговом окне **Выберите шаблон из нового проекта** выберите элементы **Интернет и консоль** > **Библиотека** > **Библиотека классов** и нажмите кнопку **Далее**.
...
1. В диалоговом окне **Configure your new Class Library** (Настройка новой библиотеки классов) выберите **.NET 5.0**, а затем нажмите кнопку **Далее**.
...
1. В главном меню выберите **Вид** > **Решение** и щелкните значок закрепления, чтобы панель была открытой.
...
> [Тестирование библиотеки классов .NET с помощью Visual Studio для Mac](testing-library-with-visual-studio-mac.md)
