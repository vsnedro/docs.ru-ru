...
Первые две позиции в номере версии пакета SDK для .NET зарезервированы для версии среды выполнения .NET, с которой выпускается пакет SDK. Каждая версия пакета SDK позволяет создавать приложения для этой среды выполнения и любых ее предыдущих версий.
...
| Среда выполнения и исправление для пакета SDK | 2.2.1             | 2.2.102           |
