...
> [!IMPORTANT]
> Windows и macOS еще не поддерживают **TLS 1.3**.
...
- [Изучите критические отличия между версиями между .NET Core 2.2 и 3.0.](../compatibility/3.0.md)
