...
- Если вы компилируете приложение .NET из командной строки, добавьте [параметр компилятора -doc](language-reference/compiler-options/doc-compiler-option.md) во время компиляции.  
