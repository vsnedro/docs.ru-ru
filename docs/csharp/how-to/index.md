...
- [Использование операторов сопоставления шаблонов `as` и `is` для безопасного приведения к другому типу](safely-cast-using-pattern-matching-is-and-as-operators.md).
