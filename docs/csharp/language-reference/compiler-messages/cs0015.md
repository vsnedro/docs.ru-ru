---
description: Ошибка компилятора CS0015
...
ms.locfileid: "89122411"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="e10aa-103">Ошибка компилятора CS0015</span><span class="sxs-lookup"><span data-stu-id="e10aa-103">Compiler Error CS0015</span></span>

<span data-ttu-id="e10aa-104">Недопустимо длинное имя типа "type"</span><span class="sxs-lookup"><span data-stu-id="e10aa-104">The name of type 'type' is too long</span></span>

 <span data-ttu-id="e10aa-105">Полное имя пользовательского типа должно быть меньше 1024 символов, включая точки.</span><span class="sxs-lookup"><span data-stu-id="e10aa-105">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="e10aa-106">Следующий пример приводит к возникновению ошибки CS0015:</span><span class="sxs-lookup"><span data-stu-id="e10aa-106">The following sample generates CS0015:</span></span>
