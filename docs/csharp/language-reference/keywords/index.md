...
|[set](set.md)|[unmanaged (ограничение универсального типа)](where-generic-type-constraint.md)|[value](value.md)|
|[var](var.md)|[when (условие фильтра)](when.md)|[where (ограничение универсального типа)](where-generic-type-constraint.md)|
|[where (предложение запроса)](where-clause.md)|[yield](yield.md)| |
