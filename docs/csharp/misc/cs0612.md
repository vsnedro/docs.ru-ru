...
"член" устарел  
 ...
 Конструктор классов пометил член [атрибутом Obsolete](../language-reference/attributes/general.md#obsolete-attribute). Это означает, что этот член может не поддерживаться в будущих версиях данного класса.  
