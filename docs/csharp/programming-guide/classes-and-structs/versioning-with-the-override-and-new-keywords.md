...
description: Узнайте об управлении версиями для базовых и производных классов в C# и о том, как указать, что метод предназначен для переопределения или скрытия наследуемого метода.
ms.date: 07/20/2015
helpviewer_keywords:
...
- Чтобы применить ключевое слово `override` к методу в производном классе, необходимо [фактически](../../language-reference/keywords/virtual.md) определить метод базового класса.
