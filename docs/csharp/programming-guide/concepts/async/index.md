...
> [!IMPORTANT]
> Общее затраченное время примерно равно времени выполнения начальной синхронной версии кода. Этот код можно улучшить, воспользовавшись некоторыми основными возможностями асинхронного программирования.
