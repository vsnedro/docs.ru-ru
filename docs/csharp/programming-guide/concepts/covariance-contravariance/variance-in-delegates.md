...
### <a name="generic-delegates-that-have-variant-type-parameters-in-net"></a>Универсальные методы-делегаты с вариативными параметрами типа в .NET
