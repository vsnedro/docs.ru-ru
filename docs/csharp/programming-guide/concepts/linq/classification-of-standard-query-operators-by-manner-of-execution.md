...
description: 'Узнайте о способах выполнения стандартного оператора запроса в C# для LINQ to Objects: интерпретация, отложенное потоковое выполнение и отложенное непотоковое выполнение.'
ms.date: 07/20/2015
