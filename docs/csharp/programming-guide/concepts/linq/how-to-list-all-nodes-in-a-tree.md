...
description: Узнайте, как в C# вывести список всех узлов в дереве путем выполнения выражения XPath с помощью LINQ to XML. Можно узнать, как метод или свойство влияют на дерево.
ms.date: 07/20/2015
