...
description: Узнайте о вопросах безопасности, связанных с LINQ to XML, и изучите некоторые рекомендации по снижению рисков нарушения безопасности.
ms.date: 07/20/2015
