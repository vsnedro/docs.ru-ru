...
description: В этой статье LINQ to XML сравнивается с такими технологиями XML, как XmlReader, XSLT, MSXML и XmlLite, чтобы помочь вам определиться с выбором.
ms.date: 07/20/2015
