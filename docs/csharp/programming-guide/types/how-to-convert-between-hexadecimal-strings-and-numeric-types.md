...
## <a name="example"></a>Пример  
 ...
 В следующем примере показано преобразование массива [байтов](../../language-reference/builtin-types/integral-numeric-types.md) в шестнадцатеричную строку посредством вызова метода <xref:System.Convert.ToHexString%2A?displayProperty=nameWithType>, который был представлен в .NET 5.0.
