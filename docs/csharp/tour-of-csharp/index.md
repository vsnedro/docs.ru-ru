...
- [Типы значений](../language-reference/builtin-types/value-types.md)
  - [Простые типы](../language-reference/builtin-types/value-types.md#built-in-value-types)
    ...
    - [Символы Юникода](/dotnet/standard/base-types/character-encoding-introduction): `char`, который представляет блок кода в кодировке UTF-16.
  ...
  - [Типы значений кортежей](../tuples.md)
...
- [Ссылочные типы](../language-reference/keywords/reference-types.md)
  - [Типы классов](../language-reference/keywords/class.md)
    ...
    - [Строки в Юникоде](/dotnet/standard/base-types/character-encoding-introduction): `string`, который представляет последовательность блоков кода в кодировке UTF-16.
  ...
  - [Типы массивов](../programming-guide/arrays/index.md)
    - Одно-мерные, многомерные массивы и массивы массивов, например `int[]`, `int[,]` и `int[][]`.
  - [Типы делегатов](../language-reference/keywords/delegate.md)
