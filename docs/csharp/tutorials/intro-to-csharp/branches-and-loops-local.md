...
Цикл `while`, `do` или `for` можно вложить в другой цикл, чтобы создать матрицу, использующую сочетание каждого элемента во внешнем цикле с каждым элементом во внутреннем цикле. Давайте сделаем это для получения набора из буквенно-цифровых пар, представляющих строки и столбцы.
