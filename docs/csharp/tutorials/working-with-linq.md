...
Для этого есть сразу несколько причин. Вы можете решить одну из самых существенных причин спада производительности — неэффективное использование [*отложенного вычисления*](../../standard/linq/deferred-execution-lazy-evaluation.md).
