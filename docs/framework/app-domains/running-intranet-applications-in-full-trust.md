...
description: Запустите приложения интрасети с полным доверием, используя .NET Framework 3.5 SP1. Приложения и их сборки библиотек можно запускать как сборки с полным доверием из сетевой папки.
ms.date: 03/30/2017
helpviewer_keywords:
