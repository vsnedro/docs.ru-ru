...
---
# <a name="certificate-element"></a>Элемент \<certificate>
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<peer>](peer-of-clientcredentials-element.md)|Задает учетные данные, используемые при проверке подлинности одноранговых клиентов.|  
