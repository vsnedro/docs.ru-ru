...
---
# <a name="message-element-of-nettcpbinding"></a>Элемент \<message> для \<netTcpBinding>
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<security>](security-of-nettcpbinding.md)|Определяет возможности безопасности для элемента <xref:System.ServiceModel.Configuration.NetTcpBindingElement>.|  
