...
---
# <a name="message-of-wsdualhttpbinding"></a>\<message> из \<wsDualHttpBinding>
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<security>](security-of-wsdualhttpbinding.md)|Определяет возможности безопасности для [\<wsDualHttpBinding>](wsdualhttpbinding.md) .|  
