...
---
# <a name="states-of-activitystatequery"></a>\<states> из \<activityStateQuery>
...
|Элемент|Описание|  
|-------------|-----------------|  
|[\<state>](state-of-states.md)|Элемент конфигурации, содержащий состояния подписанного действия, для которого необходимо создать запись отслеживания.|  
