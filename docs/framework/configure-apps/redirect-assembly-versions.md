...
## <a name="specifying-assembly-binding-in-configuration-files"></a>Указание привязки сборки в файлах конфигурации
 ...
 Для привязки сборки необходимо указать строку "urn: schemas-microsoft-com: ASM. v1" с атрибутом **xmlns** в [\<assemblyBinding>](./file-schema/runtime/assemblybinding-element-for-runtime.md) теге.
...
- [\<bindingRedirect> Элемент](./file-schema/runtime/bindingredirect-element.md)
