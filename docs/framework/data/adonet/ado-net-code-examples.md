...
В листингах кода на этой странице показано, как получить данные из базы данных с помощью следующих технологий ADO.NET:
...
- [Создание приложений для работы с данными](/previous-versions/visualstudio/visual-studio-2013/h0y4a0f6(v=vs.120))
- [Запросы к модели EDM (задачи Entity Framework)](/previous-versions/bb738455(v=vs.90))
