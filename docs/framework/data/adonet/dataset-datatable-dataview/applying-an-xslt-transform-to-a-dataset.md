...
Метод **WriteXml** объекта <xref:System.Data.DataSet> позволяет записывать содержимое **набора** данных в виде XML-данных. После этого типичной задачей является преобразование этого XML в другой формат с помощью XSLT-преобразования (XSLT). Однако синхронизация **набора данных** с помощью <xref:System.Xml.XmlDataDocument> позволяет применить таблицу стилей XSLT к содержимому **набора данных** без необходимости сначала писать содержимое **набора** данных в виде XML-данных с помощью метода **WriteXml**.  
