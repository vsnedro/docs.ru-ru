...
Существует несколько способов работы с <xref:System.Data.DataSet>, которые могут применяться отдельно или в сочетании. Можно сделать следующее:  
...
## <a name="in-this-section"></a>Содержание раздела
 ...
 [Руководство по безопасности](security-guidance.md)  
