...
Организация пулов соединений может существенно улучшить производительность и масштабируемость приложения. В этом разделе обсуждаются пулы соединений для платформа .NET Framework поставщиков данных для OLE DB, ODBC и Oracle.
...
```
 ...
 Дополнительные сведения о OLE DB сеансах или пулах ресурсов, а также о том, как отключить пулы путем переопределения значений по умолчанию службы поставщика OLE DB, см. в разделе [руководство программиста OLE DB](/previous-versions/windows/desktop/ms713643(v=vs.85)).
