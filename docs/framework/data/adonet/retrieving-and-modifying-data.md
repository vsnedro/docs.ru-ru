...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Описывает, как получить двоичные данные или крупные структуры данных с помощью `CommandBehavior` .`SequentialAccess` изменение поведения по умолчанию для `DataReader` .  
