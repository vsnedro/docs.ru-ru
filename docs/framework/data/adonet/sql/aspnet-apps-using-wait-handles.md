---
description: 'Дополнительные сведения о: ASP.NET приложения с помощью дескрипторов ожидания'
