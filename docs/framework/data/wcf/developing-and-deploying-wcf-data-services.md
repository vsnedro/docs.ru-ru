...
При разработке службы данных учитывайте следующее.

- Если вы планируете проверять подлинность пользователей или ограничить доступ для конкретных пользователей, определите требования к безопасности службы данных. Дополнительные сведения см. в разделе [Securing WCF Data Services](securing-wcf-data-services.md).
...
- **Веб-сервер, размещенный в службах IIS**
  ...
  - **Технологии развертывания для веб-приложений ASP.NET**
    ...
    - [Инструкции. Развертывание веб-проекта с помощью One-Click Publish в Visual Studio](/previous-versions/aspnet/dd465337(v=vs.110))
