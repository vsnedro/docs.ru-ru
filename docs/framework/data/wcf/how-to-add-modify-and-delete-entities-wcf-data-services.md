...
С помощью клиентских библиотек WCF Data Services можно создавать, обновлять и удалять данные сущностей в службе данных, выполняя эквивалентные действия с объектами в <xref:System.Data.Services.Client.DataServiceContext> . Дополнительные сведения см. [в разделе Обновление службы данных](updating-the-data-service-wcf-data-services.md).  
