...
description: Начало работы с .NET Framework — средой выполнения, которая контролирует приложения, а также содержит общеязыковую среду выполнения (CLR) и обширную библиотеку классов.
ms.date: 10/21/2020
helpviewer_keywords:
...
<a name="ForUsers"></a>
## <a name="net-framework-for-users"></a>.NET Framework для пользователей
...
| [Документация по .NET Core](../../core/introduction.md) | Концептуальная и справочная документация по API для .NET Core. |
