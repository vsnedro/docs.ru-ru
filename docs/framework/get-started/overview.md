---
title: Общие сведения о платформе .NET
description: Прочитайте общие сведения о .NET Framework. Это технология, которая поддерживает создание и выполнение веб-служб и приложений для Windows.
ms.date: 10/21/2020
helpviewer_keywords:
