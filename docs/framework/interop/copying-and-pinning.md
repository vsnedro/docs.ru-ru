...
description: См. сведения о том, как средство маршалинга взаимодействия может копировать или закреплять данные, которые маршалируются. Копируемые данные помещаются из одной области памяти в другую.
ms.date: 03/30/2017
helpviewer_keywords:
