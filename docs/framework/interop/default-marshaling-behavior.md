...
> [!NOTE]
> Маршалинг универсальных типов не поддерживается. Дополнительные сведения см. в разделе [Взаимодействие с помощью универсальных типов](/previous-versions/dotnet/netframework-4.0/ms229590(v=vs.100)).  
