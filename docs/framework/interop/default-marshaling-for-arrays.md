...
|--------------------|-------------------|  
|**SafeArray(** *Тип* **)**|**ELEMENT_TYPE_SZARRAY** **\<** *Преобразованный_тип* **>**<br /><br /> Ранг = 1, нижняя граница = 0. Размер известен только в том случае, если он предоставлен в управляемой сигнатуре. Безопасные массивы, ранг которых не равен 1, а нижняя граница не равна 0, не поддерживают маршалинг в виде **SZARRAY**.|  
|*Type*  **[]**|**ELEMENT_TYPE_SZARRAY** **\<** *Преобразованный_тип* **>**<br /><br /> Ранг = 1, нижняя граница = 0. Размер известен только в том случае, если он предоставлен в управляемой сигнатуре.|  
...
|------------------------|-----------------|  
|**ELEMENT_TYPE_SZARRAY** **\<** *тип* **>**|<xref:System.Runtime.InteropServices.UnmanagedType> **.SafeArray(** *тип* **)**<br /><br /> **UnmanagedType.LPArray**<br /><br /> Тип предоставляется в сигнатуре. Ранг всегда равен 1, а нижняя граница всегда — 0. Размер всегда известен во время выполнения.|  
|**ELEMENT_TYPE_ARRAY** **\<** *тип* **>** **\<** *ранг* **>** [ **\<** *границы* **>** ]|**UnmanagedType.SafeArray(** *тип* **)**<br /><br /> **UnmanagedType.LPArray**<br /><br /> Тип, ранг и границы предоставляются в сигнатуре. Размер всегда известен во время выполнения.|  
