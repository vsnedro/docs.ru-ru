...
- [Программирование с использованием основных сборок взаимодействия](/previous-versions/dotnet/netframework-4.0/baxfadst(v=vs.100))
- [Locating Primary Interop Assemblies](/previous-versions/dotnet/netframework-4.0/y06sxw56(v=vs.100)) (Обнаружение основных сборок взаимодействия)
- [Распространение основных сборок взаимодействия](/previous-versions/dotnet/netframework-4.0/w0dt2w20(v=vs.100))
