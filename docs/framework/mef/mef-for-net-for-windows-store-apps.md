...
- <xref:System.Composition.Hosting.Core?displayProperty=nameWithType> предоставляет типы MEF, которые использует обработчик композиции.  
 ...
 Дополнительные сведения о платформе .NET для приложений Windows 8.x магазина Windows Store и список входящих в нее пространств имен и типов см. в статье [Обзор приложений .NET для Магазина Windows](https://docs.microsoft.com/previous-versions/br230302(v=vs.110)).
