...
- В документе с описанием [критических изменений в .NET Framework 2.0](/previous-versions/aa570326(v=msdn.10)) перечислены изменения, внесенные в .NET Framework 2.0 с пакетом обновления 1 (SP1), которые могут повлиять на приложение, предназначенное для .NET Framework 1.1.

- В документе с описанием [изменений в .NET Framework 3.5 с пакетом обновления 1 (SP1)](/previous-versions/dotnet/articles/dd310284(v=msdn.10)) перечислены различия между .NET Framework 3.5 и NET Framework 3.5 с пакетом обновления 1 (SP1).
