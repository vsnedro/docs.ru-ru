...
description: Сведения о проблемах с совместимостью приложений, которые могут повлиять на работу приложения при миграции с .NET Framework 4.0 на 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "91609716"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="0bfac-103">Изменение целевой платформы для миграции с .NET Framework 4.0 на 4.5.1</span><span class="sxs-lookup"><span data-stu-id="0bfac-103">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="0bfac-104">Если выполняется миграция с .NET Framework версии 4.0 на 4.5.1, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="0bfac-104">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="0bfac-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="0bfac-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="0bfac-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0bfac-106">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="0bfac-107">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="0bfac-107">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="0bfac-108">Ядро</span><span class="sxs-lookup"><span data-stu-id="0bfac-108">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0bfac-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0bfac-109">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="0bfac-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="0bfac-110">MSBuild</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="0bfac-111">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="0bfac-111">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0bfac-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0bfac-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0bfac-113">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0bfac-113">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="0bfac-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="0bfac-114">XML, XSLT</span></span>
