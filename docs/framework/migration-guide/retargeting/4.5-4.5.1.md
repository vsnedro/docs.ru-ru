...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="eebf2-103">Изменение целевой платформы для миграции с .NET Framework 4.5 на 4.5.1</span><span class="sxs-lookup"><span data-stu-id="eebf2-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="eebf2-104">Если выполняется миграция с .NET Framework версии 4.5 на 4.5.1, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="eebf2-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="eebf2-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="eebf2-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="eebf2-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="eebf2-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="eebf2-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="eebf2-107">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="eebf2-108">MSBuild</span><span class="sxs-lookup"><span data-stu-id="eebf2-108">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="eebf2-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="eebf2-109">Windows Presentation Foundation (WPF)</span></span>
