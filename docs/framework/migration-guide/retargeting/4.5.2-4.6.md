...
description: Сведения о проблемах с совместимостью приложений, которые могут повлиять на работу приложения при миграции с .NET Framework 4.5.2 на 4.6.
ms.date: 07/10/2019
...
ms.locfileid: "86443745"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="45eec-103">Изменение целевой платформы для миграции с .NET Framework 4.5.2 на 4.6</span><span class="sxs-lookup"><span data-stu-id="45eec-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="45eec-104">Если выполняется миграция с .NET Framework версии 4.5.2 на 4.6, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="45eec-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="45eec-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="45eec-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="45eec-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="45eec-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="45eec-107">Ядро</span><span class="sxs-lookup"><span data-stu-id="45eec-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="45eec-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="45eec-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="45eec-109">JIT</span><span class="sxs-lookup"><span data-stu-id="45eec-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="45eec-110">Сети</span><span class="sxs-lookup"><span data-stu-id="45eec-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="45eec-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="45eec-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="45eec-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="45eec-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="45eec-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="45eec-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="45eec-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="45eec-114">XML, XSLT</span></span>
