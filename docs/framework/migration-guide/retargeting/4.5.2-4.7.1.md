...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="3e05a-103">Изменение целевой платформы для миграции с .NET Framework 4.5.2 на 4.7.1</span><span class="sxs-lookup"><span data-stu-id="3e05a-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="3e05a-104">Если выполняется миграция с .NET Framework версии 4.5.2 на 4.7.1, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="3e05a-104">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="3e05a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3e05a-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="3e05a-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="3e05a-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="3e05a-107">Ядро</span><span class="sxs-lookup"><span data-stu-id="3e05a-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3e05a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3e05a-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="3e05a-109">JIT</span><span class="sxs-lookup"><span data-stu-id="3e05a-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="3e05a-110">Сети</span><span class="sxs-lookup"><span data-stu-id="3e05a-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="3e05a-111">Безопасность</span><span class="sxs-lookup"><span data-stu-id="3e05a-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3e05a-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3e05a-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3e05a-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3e05a-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3e05a-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3e05a-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3e05a-115">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3e05a-115">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3e05a-116">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="3e05a-116">XML, XSLT</span></span>
