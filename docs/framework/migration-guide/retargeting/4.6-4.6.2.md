...
description: Сведения о проблемах с совместимостью приложений, которые могут повлиять на работу приложения при миграции с .NET Framework 4.6 на 4.6.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444174"
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="ed89c-103">Изменение целевой платформы для миграции с .NET Framework 4.6 на 4.6.2</span><span class="sxs-lookup"><span data-stu-id="ed89c-103">Retargeting Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="ed89c-104">Если выполняется миграция с .NET Framework версии 4.6 на 4.6.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="ed89c-104">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ed89c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ed89c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ed89c-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="ed89c-106">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="ed89c-107">Безопасность</span><span class="sxs-lookup"><span data-stu-id="ed89c-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ed89c-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ed89c-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="ed89c-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="ed89c-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ed89c-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ed89c-110">Windows Presentation Foundation (WPF)</span></span>
