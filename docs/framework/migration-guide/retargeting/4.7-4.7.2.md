...
ms.locfileid: "85622514"
---
# <a name="retargeting-changes-for-migration-from-net-framework-47-to-472"></a><span data-ttu-id="ff07b-102">Изменение целевой платформы для миграции с .NET Framework 4.7 на 4.7.2</span><span class="sxs-lookup"><span data-stu-id="ff07b-102">Retargeting Changes for Migration from .NET Framework 4.7 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="ff07b-103">Если выполняется миграция с .NET Framework версии 4.7 на 4.7.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="ff07b-103">If you are migrating from the .NET Framework 4.7 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ff07b-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ff07b-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ff07b-105">Ядро</span><span class="sxs-lookup"><span data-stu-id="ff07b-105">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="ff07b-106">Безопасность</span><span class="sxs-lookup"><span data-stu-id="ff07b-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ff07b-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ff07b-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="ff07b-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="ff07b-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ff07b-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ff07b-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ff07b-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ff07b-110">Windows Workflow Foundation (WF)</span></span>
