...
ms.locfileid: "85622462"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="3b77c-102">Изменение среды выполнения для миграции с .NET Framework 4.0 на 4.5.1</span><span class="sxs-lookup"><span data-stu-id="3b77c-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="3b77c-103">Если выполняется миграция с .NET Framework версии 4.0 на 4.5.1, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="3b77c-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3b77c-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3b77c-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3b77c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3b77c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3b77c-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="3b77c-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3b77c-107">Данные</span><span class="sxs-lookup"><span data-stu-id="3b77c-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="3b77c-108">Отладчик</span><span class="sxs-lookup"><span data-stu-id="3b77c-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3b77c-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3b77c-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="3b77c-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="3b77c-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="3b77c-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="3b77c-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="3b77c-112">Сети</span><span class="sxs-lookup"><span data-stu-id="3b77c-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="3b77c-113">Печать</span><span class="sxs-lookup"><span data-stu-id="3b77c-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3b77c-114">Сериализация</span><span class="sxs-lookup"><span data-stu-id="3b77c-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="3b77c-115">Веб-приложения</span><span class="sxs-lookup"><span data-stu-id="3b77c-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3b77c-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3b77c-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3b77c-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="3b77c-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3b77c-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3b77c-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3b77c-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3b77c-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3b77c-120">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="3b77c-120">XML, XSLT</span></span>
