...
ms.locfileid: "85622410"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="54244-102">Изменение среды выполнения для миграции с .NET Framework 4.0 на 4.5</span><span class="sxs-lookup"><span data-stu-id="54244-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="54244-103">Если выполняется миграция с .NET Framework версии 4.0 на 4.5, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="54244-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="54244-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="54244-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="54244-105">Ядро</span><span class="sxs-lookup"><span data-stu-id="54244-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="54244-106">Данные</span><span class="sxs-lookup"><span data-stu-id="54244-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="54244-107">Отладчик</span><span class="sxs-lookup"><span data-stu-id="54244-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="54244-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="54244-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="54244-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="54244-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="54244-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="54244-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="54244-111">Сети</span><span class="sxs-lookup"><span data-stu-id="54244-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="54244-112">Печать</span><span class="sxs-lookup"><span data-stu-id="54244-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="54244-113">Сериализация</span><span class="sxs-lookup"><span data-stu-id="54244-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="54244-114">Веб-приложения</span><span class="sxs-lookup"><span data-stu-id="54244-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="54244-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="54244-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="54244-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="54244-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="54244-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="54244-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="54244-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="54244-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="54244-119">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="54244-119">XML, XSLT</span></span>
