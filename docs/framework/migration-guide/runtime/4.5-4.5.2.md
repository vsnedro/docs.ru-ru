...
ms.locfileid: "85622397"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="bd8e9-102">Изменение среды выполнения для миграции с .NET Framework 4.5 на 4.5.2</span><span class="sxs-lookup"><span data-stu-id="bd8e9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="bd8e9-103">Если выполняется миграция с .NET Framework версии 4.5 на 4.5.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="bd8e9-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="bd8e9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="bd8e9-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="bd8e9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="bd8e9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="bd8e9-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="bd8e9-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="bd8e9-107">Данные</span><span class="sxs-lookup"><span data-stu-id="bd8e9-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="bd8e9-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="bd8e9-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="bd8e9-109">Сериализация</span><span class="sxs-lookup"><span data-stu-id="bd8e9-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="bd8e9-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="bd8e9-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="bd8e9-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="bd8e9-111">Windows Presentation Foundation (WPF)</span></span>
