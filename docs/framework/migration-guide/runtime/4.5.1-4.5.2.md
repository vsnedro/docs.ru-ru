...
description: Сведения о проблемах с совместимостью приложений в связи с изменением среды выполнения, которые могут повлиять на работу приложения при миграции с .NET Framework 4.5.1 на 4.5.2.
ms.date: 07/10/2019
...
ms.locfileid: "86443576"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="54136-103">Изменение среды выполнения для миграции с .NET Framework 4.5.1 на 4.5.2</span><span class="sxs-lookup"><span data-stu-id="54136-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="54136-104">Если выполняется миграция с .NET Framework версии 4.5.1 на 4.5.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="54136-104">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="54136-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="54136-105">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="54136-106">Данные</span><span class="sxs-lookup"><span data-stu-id="54136-106">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="54136-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="54136-107">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="54136-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="54136-108">Windows Presentation Foundation (WPF)</span></span>
