...
description: Сведения о проблемах с совместимостью приложений в связи с изменением среды выполнения, которые могут повлиять на работу приложения при миграции с .NET Framework 4.5.1 на 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443563"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="33903-103">Изменение среды выполнения для миграции с .NET Framework 4.5.1 на 4.6.1</span><span class="sxs-lookup"><span data-stu-id="33903-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="33903-104">Если выполняется миграция с .NET Framework версии 4.5.1 на 4.6.1, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="33903-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="33903-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="33903-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="33903-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="33903-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="33903-107">Данные</span><span class="sxs-lookup"><span data-stu-id="33903-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="33903-108">Отладчик</span><span class="sxs-lookup"><span data-stu-id="33903-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="33903-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="33903-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="33903-110">Сети</span><span class="sxs-lookup"><span data-stu-id="33903-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="33903-111">Сериализация</span><span class="sxs-lookup"><span data-stu-id="33903-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="33903-112">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="33903-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="33903-113">Инструменты</span><span class="sxs-lookup"><span data-stu-id="33903-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="33903-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="33903-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="33903-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="33903-115">Windows Presentation Foundation (WPF)</span></span>
