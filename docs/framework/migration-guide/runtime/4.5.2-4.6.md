...
description: Сведения о проблемах с совместимостью приложений в связи с изменением среды выполнения, которые могут повлиять на работу приложения при миграции с .NET Framework 4.5.2 на 4.6.
ms.date: 07/10/2019
...
ms.locfileid: "86442172"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="f0820-103">Изменение среды выполнения для миграции с .NET Framework 4.5.2 на 4.6</span><span class="sxs-lookup"><span data-stu-id="f0820-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="f0820-104">Если выполняется миграция с .NET Framework версии 4.5.2 на 4.6, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="f0820-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f0820-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f0820-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f0820-106">Ядро</span><span class="sxs-lookup"><span data-stu-id="f0820-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="f0820-107">Данные</span><span class="sxs-lookup"><span data-stu-id="f0820-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="f0820-108">Отладчик</span><span class="sxs-lookup"><span data-stu-id="f0820-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="f0820-109">Сети</span><span class="sxs-lookup"><span data-stu-id="f0820-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="f0820-110">Сериализация</span><span class="sxs-lookup"><span data-stu-id="f0820-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="f0820-111">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="f0820-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f0820-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f0820-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f0820-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f0820-113">Windows Presentation Foundation (WPF)</span></span>
