...
description: Сведения о проблемах с совместимостью приложений в связи с изменением среды выполнения, которые могут повлиять на работу приложения при миграции с .NET Framework 4.6.1 на 4.7.
ms.date: 07/10/2019
...
ms.locfileid: "86443953"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="b7b9b-103">Изменение среды выполнения для миграции с .NET Framework 4.6.1 на 4.7</span><span class="sxs-lookup"><span data-stu-id="b7b9b-103">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b7b9b-104">Если выполняется миграция с .NET Framework версии 4.6.1 на 4.7, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="b7b9b-104">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="b7b9b-105">Данные</span><span class="sxs-lookup"><span data-stu-id="b7b9b-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b7b9b-106">Глобализация</span><span class="sxs-lookup"><span data-stu-id="b7b9b-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="b7b9b-107">JIT</span><span class="sxs-lookup"><span data-stu-id="b7b9b-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="b7b9b-108">Безопасность</span><span class="sxs-lookup"><span data-stu-id="b7b9b-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b7b9b-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b7b9b-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b7b9b-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b7b9b-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b7b9b-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b7b9b-111">Windows Workflow Foundation (WF)</span></span>
