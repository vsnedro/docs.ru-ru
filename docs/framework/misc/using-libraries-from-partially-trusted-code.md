...
description: Узнайте, как использовать библиотеки из частично доверенного кода. Используйте атрибут AllowPartiallyTrustedCallersAttribute для вызова общих управляемых библиотек.
ms.date: 03/30/2017
helpviewer_keywords:
