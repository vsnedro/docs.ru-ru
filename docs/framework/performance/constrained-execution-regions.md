...
description: Приступая к работе с областями ограниченного выполнения (CER), которые являются частью механизма создания надежного управляемого кода.
ms.date: 03/30/2017
helpviewer_keywords:
