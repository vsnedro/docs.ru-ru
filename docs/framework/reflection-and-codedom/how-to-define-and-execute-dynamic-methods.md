...
- [Сценарии динамических методов порождаемого отражения](/previous-versions/dotnet/netframework-4.0/sfk2s47t(v=vs.100))
