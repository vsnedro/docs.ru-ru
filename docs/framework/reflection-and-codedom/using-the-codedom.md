...
### <a name="more-information-on-building-a-codedom-graph"></a>Дополнительные сведения о построении графа CodeDOM  
 ...
 Быстро найти элемент CodeDOM, представляющий определенный тип элемента кода, можно в разделе [Краткий справочник по CodeDOM](/previous-versions/dotnet/netframework-4.0/f1dfsbhc(v=vs.100)).
