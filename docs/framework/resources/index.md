...
description: Сведения о ресурсах в приложениях .NET. Ресурс представляет собой любые неисполняемые данные, которые логически развертываются вместе с приложением.
ms.date: 07/25/2018
helpviewer_keywords:
