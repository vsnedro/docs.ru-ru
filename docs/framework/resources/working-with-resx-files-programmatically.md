...
description: Создавайте или извлекайте данные из XML-файлов ресурсов (RESX-файлов) программным способом с помощью типов и членов из пространства имен System.Resources библиотеки классов .NET.
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
Здесь рассматривается работа с XML-файлами (RESX-файлами), содержащими ресурсы. Сведения о работе с двоичными файлами ресурсов, внедренными в сборки, см. в статье <xref:System.Resources.ResourceManager>.
...
В следующем примере создается RESX-файл с именем CarResources.resx, в котором хранятся шесть строк, значок и два объекта, определяемых приложением (два объекта `Automobile` ). Класс `Automobile`, определенный и созданный в этом примере, отмечен атрибутом <xref:System.SerializableAttribute>.
 ...
 **vbc** *имя-файла* **.vb -resource:** *.имя_файла_ресурсов*.

 При использовании C# синтаксис следующий:

 **csc** *имя_файла* **.cs -resource:** *.имя_файла_ресурсов*.
 ...
 **al** *имя_файла_ресурсов* **-out:** *имя_файла_сборки*.
