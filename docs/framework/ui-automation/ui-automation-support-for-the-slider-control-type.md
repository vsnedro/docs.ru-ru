...
|------------------|------------------|  
|Ползунок<br /><br /> -Кнопка (2 или 4)<br />-Thumb (только 1)<br />— Элемент списка (0 или более)|Ползунок<br /><br /> — Элемент списка (0 или более)|  
