...
В коротких случаях доступные технологии, для которых требуется доступ только для чтения к хранилищу текста <xref:System.Windows.Automation.TextPattern> , могут использовать, но для контекстно-ориентированного ввода потребуется более сложная функциональность TSF.
...
![Текстпаттернранжеендпоинтс &#40;начала и окончания&#41;.](./media/uia-textpattern-endpoints.PNG "UIA_TextPattern_Endpoints")
