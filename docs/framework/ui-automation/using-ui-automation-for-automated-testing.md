...
description: Ознакомьтесь с обзором, в котором описывается использование модели автоматизации пользовательского интерфейса в качестве платформы для программного доступа в сценариях автоматического тестирования.
ms.date: 03/30/2017
helpviewer_keywords:
- automated testing
...
|--------------------------------|------------------|---------------------------------|----------------------------|  
|Кнопка|Windows Presentation Foundation|Content|NameProperty|  
|Кнопка|Win32|Заголовок|NameProperty|  
|Образ —|HTML|alt|NameProperty|  
...
- Inspect.exe — это приложение графического пользовательского интерфейса, которое можно использовать для сбора [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] информации о разработке и отладке поставщика и клиента. Inspect.exe входит в Windows SDK.  
  
- Мсаабридже предоставляет [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] сведения для Active Accessibility клиентов. Основная цель моста [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] с Active Accessibility — разрешить существующим клиентам Active Accessibility возможность взаимодействия с любой реализуемой платформой [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] .  
