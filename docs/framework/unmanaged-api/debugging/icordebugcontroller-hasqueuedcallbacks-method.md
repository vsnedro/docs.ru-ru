...
## <a name="parameters"></a>Параметры  
 ...
 Если для `pThread` параметра задано значение null, `HasQueuedCallbacks` функция возвратит `true` , если в настоящий момент в очереди есть управляемые обратные вызовы для любого потока.  
