...
## <a name="remarks"></a>Remarks  
 ...
 Вызовы CLR `SuspensionStarting` для информирования узла о сборке мусора.  
  
> [!IMPORTANT]
> Не Перепланируйте эту задачу. Узел должен перепланировать задачу при вызове [среадисблоккингфорсуспенсион](ihostgcmanager-threadisblockingforsuspension-method.md) .  
