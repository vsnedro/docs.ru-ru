...
Для неверно сформированных сообщений `source` значение равно `Malformed` . В противном случае поле source будет иметь следующие значения в зависимости от контекста.
