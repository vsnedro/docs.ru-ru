...
В этом разделе перечислены все исключения в следующих областях, созданных Windows Communication Foundation (WCF):  
 ...
 [Основное взаимодействие: структура подключений](core-communications-connection-framework.md)  
 ...
 [Основное взаимодействие: транспортные каналы именованных каналов](core-communications-named-pipe-transport-channels.md)  
  
 [Основное взаимодействие: транспортные каналы TCP](core-communications-tcp-transport-channels.md)  
  
 [Основное взаимодействие: транспортная структура](core-communications-transport-framework.md)  
