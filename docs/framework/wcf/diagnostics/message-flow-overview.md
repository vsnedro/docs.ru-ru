...
- Сквозная модель действий для служб WCF/WF: эта возможность поддерживает корреляцию трассировок, создаваемых пространствами имен <xref:System.ServiceModel> и <xref:System.Workflow.ComponentModel>.
