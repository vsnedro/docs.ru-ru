...
> [!NOTE]
> Кроме того, действия можно определить программно для группирования пользовательских трассировок. Дополнительные сведения см. в разделе [эмиссия трассировок пользовательского кода](emitting-user-code-traces.md).  
...
|N|Открыть ServiceHost. ServiceType: '[Type]'.|Открыть||  
