...
- События ошибок Windows при сбоях возможности трассировки. См. раздел [ведение журнала событий](../event-logging/index.md).  
 ...
 Вы можете настроить трассировку, изменив файл конфигурации приложения — Web. config для веб-приложений или Appname. exe. config для собственных приложений. Ниже приводится пример подобного изменения. Дополнительные сведения об этих параметрах см. в разделе "Настройка прослушивателей трассировки для использования трассировок".  
