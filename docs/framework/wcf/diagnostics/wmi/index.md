...
## <a name="accessing-wmi-data"></a>Доступ к данным WMI  
 ...
 Доступ к данным инструментария WMI может осуществляться несколькими различными способами. Корпорация Майкрософт предоставляет API-интерфейсы WMI для сценариев, Visual Basic приложений, приложений C++ и платформа .NET Framework. Дополнительные сведения см. [в разделе Использование WMI](/windows/win32/wmisdk/using-wmi).  
...
2. В новом окне введите **рут\сервицемодел** в поле **пространство имен** и выберите параметр **Конфиденциальность пакетов** для **уровня проверки подлинности**. Щелкните **Подключить**.  
