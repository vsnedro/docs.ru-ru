...
Если вы установили WMI Административные инструменты, вы можете использовать WMI CIM Studio для доступа к экземплярам WMI. Инструменты находятся в следующей папке:
