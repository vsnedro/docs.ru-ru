...
### <a name="use-of-dead-letter-queues"></a>Использование очередей недоставленных сообщений  
 ...
 Дополнительные сведения см. [в разделе Использование очередей недоставленных сообщений для управления сбоями при обмене сообщениями](using-dead-letter-queues-to-handle-message-transfer-failures.md).  
