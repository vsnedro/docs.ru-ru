...
1. В диалоговом окне **Новый проект** разверните узел **установленная**  >  **Visual C#**  >  **веб-** Категория Visual C#, а затем выберите **ASP.NET веб-приложение (.NET Framework)**.
...
1. В диалоговом окне **Добавление нового элемента** разверните узел **установленная**  >  **Visual C#**  >  **веб-** Категория Visual C#, а затем выберите шаблон **веб-форма** .
