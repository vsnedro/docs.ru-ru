...
> Обратите внимание, что в именах контрактов данных и пространствах имен, равно как и в именах членов данных, учитывается регистр.  
 ...
 Дополнительные сведения о именах контрактов данных и пространствах имен, а также об именах членов данных см. в разделе [имена контрактов данных](data-contract-names.md).  
