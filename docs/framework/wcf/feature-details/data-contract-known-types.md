...
- Контракт отправляемых данных унаследован из контракта ожидаемых данных. Дополнительные сведения см. в разделе о наследовании при [эквивалентности контракта данных](data-contract-equivalence.md). В этом случае контракт передаваемых данных отличается от контракта данных, ожидаемого принимающей конечной точкой;  
...
- [Известные типы](../samples/known-types.md)
