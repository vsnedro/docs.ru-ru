...
|Допускается|true|WS-AT|Транзакция может передаваться в обеспечивающем возможность взаимодействия формате WS-AT.|  
|Допускается|true|OleTransactions|Транзакция может передаваться в формате WCF OleTransactions.|  
