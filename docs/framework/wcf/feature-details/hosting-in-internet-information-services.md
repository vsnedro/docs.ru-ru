...
Описание каждой из этих задач см. в разделе [Развертывание размещенной службы IIS службы WCF](deploying-an-internet-information-services-hosted-wcf-service.md).
