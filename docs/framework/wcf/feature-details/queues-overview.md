...
## <a name="basic-queuing-concepts"></a>Основные принципы очередей  
 ...
 ![Модель взаимодействия с использованием очереди](media/qconceptual-figure1c.gif "Кконцептуал — Figure1c")  
...
- Внесение 1 000 долларов на текущий счет.  
 ...
 ![Очередь с транзакциями](media/qwithtransactions-figure3.gif "Квистрансактионс — Figure3")  
