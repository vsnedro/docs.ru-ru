...
### <a name="service-versioning"></a>Управление версиями службы  
 ...
 Действия по созданию конфигурации управления версиями службы см. [в разделе руководство. Управление версиями служб](how-to-service-versioning.md).
...
### <a name="service-data-partitioning"></a>Секционирование данных служб  
 ...
 Шаги, используемые для создания конфигурации секционирования данных службы, см. [в разделе как выполнять секционирование данных](how-to-service-data-partitioning.md)службы.  
...
### <a name="dynamic-routing"></a>Динамическая маршрутизация  
 ...
 Шаги, используемые для реализации динамической маршрутизации, см. [в разделе как динамическое обновление](how-to-dynamic-update.md).
...
### <a name="error-handling"></a>Обработка ошибок  
 ...
 Шаги, используемые для настройки обработки ошибок, см. [в разделе как обрабатывать ошибки](how-to-error-handling.md).
  
### <a name="in-this-section"></a>В этом разделе  
 [Как выполнить: Управление версиями службы](how-to-service-versioning.md)  
  
 [Как выполнить: Секционирование данных служб](how-to-service-data-partitioning.md)  
  
 [Как выполнить: Динамическое обновление](how-to-dynamic-update.md)  
  
 [Как выполнить: Обработка ошибок](how-to-error-handling.md)  
