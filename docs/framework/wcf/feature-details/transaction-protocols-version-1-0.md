...
Windows Communication Foundation (WCF) версии 1 реализует протоколы WS-Atomic Transaction и WS-координации версии 1,0. Дополнительные сведения о версии 1,1 см. в разделе [Протоколы транзакций](transaction-protocols.md).  
...
#### <a name="2pc-protocol-binding-configuration"></a>Конфигурация привязки протокола 2PC  
 ...
 B2131: реализации должны поддерживаться `wsa:ReferenceParameters` , как описано в WS-Addressing, чтобы обеспечить корреляцию сообщений 2pc WCF.  
