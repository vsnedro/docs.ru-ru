---
description: Дополнительные сведения см. в статье Использование канала клиента обнаружения.
