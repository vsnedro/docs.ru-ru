...
Службы рабочего процесса, размещенные в управляемом .NET Framework приложении или управляемой службе Windows, создают экземпляр <xref:System.ServiceModel.Activities.WorkflowServiceHost> класса и передают ему экземпляр <xref:System.ServiceModel.Activities.WorkflowService> , содержащий определение рабочего процесса в пределах <xref:System.ServiceModel.Activities.WorkflowService.Body%2A> Свойства. Определение рабочего процесса, содержащее действия обмена сообщениями, предоставлено службой рабочего процесса.
