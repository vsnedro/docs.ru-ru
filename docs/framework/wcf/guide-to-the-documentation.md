...
- Интеграция с платформа .NET Framework удаленным взаимодействием объясняется в [переносе приложений удаленного взаимодействия .NET в WCF](./feature-details/migrating-net-remoting-applications-to-wcf.md).  
