...
|----------------|-----------------|------------------------------------|  
|0|Операция выполнена успешно|None|  
|1|Непредвиденная ошибка.|Обратиться в Майкрософт|  
...
|31|Недопустимый параметр командной строки `-traceLevel`.|Исправьте параметр командной строки `-traceLevel`, чтобы задать допустимое значение из списка ниже:<br /><br /> -Выкл.<br />— Error<br />Критический<br />— Warning<br />— Сведения<br />-Verbose<br />Все|  
...
|41|Либо не удалось найти установку WinFX, либо найденная версия не соответствует возможности, которую может настроить средство.|Убедитесь, что WinFX установлен правильно, и используйте средство WsatConfig.exe, которое поставляется с этой версией WinFX для настройки WS-AT.|  
