...
```  
 ...
 Начальное значение ". \\ " обеспечивает запуск копии файла Svcutil. exe в этом каталоге (в котором находится соответствующий файл Svcutil. exe. config).  
