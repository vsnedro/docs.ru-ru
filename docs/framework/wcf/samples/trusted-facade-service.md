...
```  
 ...
 [\<security>](../../configure-apps/file-schema/wcf/security-of-custombinding.md)Элемент Binding следит за передачей и извлечением имени пользователя вызывающего объекта. [\<windowsStreamSecurity>](../../configure-apps/file-schema/wcf/windowsstreamsecurity.md)А также [\<tcpTransport>](../../configure-apps/file-schema/wcf/tcptransport.md) позаботится о проверке подлинности фасадной и серверных служб и защиты сообщений.  
