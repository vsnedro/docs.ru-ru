...
2. Откройте проект службы, выберите **создать**  >  **публикацию \<Project Name>** в главном меню или щелкните правой кнопкой мыши проект в **Обозреватель решений** и выберите команду **опубликовать**.
