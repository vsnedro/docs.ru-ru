...
|Свойство|Включено|Новое значение по умолчанию|Дополнительные сведения|
|--------------|--------|-----------------|----------------------|
