...
description: В этой статье перечислены .NET Framework действия 4.6.1 для управления потоком выполнения в рамках рабочего процесса.
ms.date: 03/30/2017
...
ms.locfileid: "83420075"
---
# <a name="control-flow-activities-in-wf"></a>Действия потока управления потока в WF
[!INCLUDE[netfx_current_long](../../../includes/netfx-current-long-md.md)] содержит несколько действий для управления потоком выполнения внутри рабочего процесса. Некоторые из этих действий (например `Switch` , и `If` ) реализуют структуры управления потоком, аналогичные тем, что есть в средах программирования, таких как Visual C#, а другие (например, `Pick` ) моделируют новые структуры программирования.  
