...
В .NET Framework 3,5 существует несколько ограничений в проектировании известных типов:
...
[DataContractResolver](../wcf/samples/datacontractresolver.md) решает эти проблемы в .NET Framework 4,5.
