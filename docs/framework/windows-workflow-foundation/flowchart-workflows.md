...
## <a name="flowchart-workflow-structure"></a>Структура рабочего процесса блок-схемы
...
### <a name="creating-a-basic-activity-sequence-with-a-flowstep-node"></a>Создание базовой последовательности действий с Фловстеп узлом
...
### <a name="creating-a-conditional-flowchart-with-a-flowdecision-node"></a>Создание условной блок-схемы с FlowDecision узлом
...
### <a name="creating-an-exclusive-switch-with-a-flowswitch-node"></a>Создание монопольного ключа с узлом FlowSwitch
