...
Windows Server App Fabric упрощает процесс настройки сохраняемости. Дополнительные сведения см. в статье [Конфигурация сохраняемости в App Fabric](/previous-versions/appfabric/ee790848(v=azure.10)).
...
- Добавляет следующий элемент расширения поведения в файл Machine.config, чтобы можно было использовать \<sqlWorkflowInstanceStore> элемент поведения службы в файле конфигурации для настройки сохраняемости для служб.
