 ...
 **"Add": не указано значение для обязательного аргумента действия "операнд2".** 
 **"Add": не указано значение для обязательного аргумента действия "операнд1".**  После передачи требуемых аргументов рабочий процесс будет успешно выполнен, как показано в следующем примере.  
