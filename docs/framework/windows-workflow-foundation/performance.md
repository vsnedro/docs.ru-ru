...
description: В этой статье описываются характеристики производительности основной редакции Windows Workflow Foundation, которая входит в .NET Framework 4.
ms.date: 03/30/2017
...
## <a name="terminology"></a>Терминология
 ...
 Версия, [!INCLUDE[wf1](../../../includes/wf1-md.md)] представленная в .NET Framework 4, будет называться WF4 в оставшейся части этого раздела. [!INCLUDE[wf1](../../../includes/wf1-md.md)] был введен в .NET Framework 3,0 и содержал несколько небольших редакций с помощью .NET Framework 3,5 с пакетом обновления 1 (SP1). В оставшейся части этого раздела для .NET Framework 3,5 версии Workflow Foundation будет называться WF3. WF3 поставляется в составе .NET Framework 4 параллельно с WF4. Дополнительные сведения о миграции артефактов WF3 в WF4 см. в разделе [руководство по миграции Windows Workflow Foundation 4](migration-guidance.md).

 Windows Communication Foundation (WCF) — это унифицированная модель программирования Майкрософт для создания приложений, ориентированных на службы. Он впервые появился в составе .NET Framework 3,0 вместе с WF3 и теперь является одним из ключевых компонентов .NET Framework.

 Windows Server AppFabric - это набор интегрированных технологий, которые упрощают построение, масштабирование и управление составными и веб-приложениями, работающими под управлением IIS. В состав этого продукта входят средства для наблюдения за службами и рабочими процессами и управления ими. Дополнительные сведения см. в статье [Windows Server AppFabric 1,0](/previous-versions/appfabric/ff384253(v=azure.10)).
...
#### <a name="test-setup"></a>Настройка теста
![Тест пропускной способности корреляции рабочего процесса](./media/performance/correlation-throughput-workflow.gif "Настройка тестирования рабочего процесса для пропускной способности корреляции")
