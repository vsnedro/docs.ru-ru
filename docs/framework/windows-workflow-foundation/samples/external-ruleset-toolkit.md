...
10. Теперь можно выполнить проект `RuleSetToolkitUsageSample`, а также остальные консольные приложения рабочего процесса. Нажмите клавишу F5 или CTRL + F5 в Visual Studio или непосредственно запустите файл RuleSetToolkitUsageSample.exe.
