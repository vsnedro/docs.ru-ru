...
[Basic](basic.md) — содержит примеры, демонстрирующие базовую функциональность Windows Workflow Foundation (WF).

[Сценарий](scenario.md) . содержит примеры сценариев Windows Workflow Foundation (WF).
