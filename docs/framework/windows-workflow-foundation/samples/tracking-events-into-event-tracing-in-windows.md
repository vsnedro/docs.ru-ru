...
4. В проводнике откройте тестовый клиент WCF.
    ...
    Тестовый клиент WCF (WcfTestClient.exe) находится в \<Visual Studio 2010 installation folder> папке \Common7\IDE\
...
>
> Не удается найти описание для идентификатора события \<id> из источника Microsoft-Windows-Application Server — приложения. Компонент, вызывающий это событие, не установлен на локальном компьютере или установка повреждена. Вы можете установить или исправить компонент на локальном компьютере.
>
