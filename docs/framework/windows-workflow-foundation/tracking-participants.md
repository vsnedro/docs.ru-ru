...
## <a name="tracking-participant-event-data"></a>Данные события участника отслеживания  
 ...
 Сложные типы в переменных, аргументах и пользовательских элементах данных сериализуются в запись событий ETW с помощью <xref:System.Runtime.Serialization.NetDataContractSerializer> класса. Этот класс включает информацию о типе CLR в сериализованном XML-потоке.  
