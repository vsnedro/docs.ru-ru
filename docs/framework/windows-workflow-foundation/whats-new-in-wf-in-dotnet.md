---
title: Новые возможности Windows Workflow Foundation в .NET Framework 4,5
...
>
> - Выражения C# будут заменены в конструкторе, при этом **значение сообщения было задано в XAML**.
