...
ms.locfileid: "84990175"
---
# <a name="application-settings-overview"></a>Общие сведения о параметрах приложений

В этой статье описывается, как создавать и хранить данные параметров от имени приложения и пользователей.
...
## <a name="what-are-application-settings"></a>Что такое параметры приложения
 Приложениям Windows Forms часто требуются данные, которые крайне важны для запуска приложения, но вы не хотите включать их непосредственно в код приложения. Если приложение использует веб-службу или сервер базы данных, эту информацию можно сохранить в отдельном файле, чтобы их можно было изменить в будущем без повторной компиляции. Аналогичным образом приложению может потребоваться сохранить данные, относящиеся к текущему пользователю. В большинстве приложений, например, применяются пользовательские предпочтения, определяющие внешний вид и поведение приложения.
