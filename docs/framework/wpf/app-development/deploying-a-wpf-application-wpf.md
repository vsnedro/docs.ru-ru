...
description: Изучите технологии развертывания, которые Windows и .NET Framework используют для приложений Windows Presentation Foundation (WPF).
ms.date: 03/30/2017
helpviewer_keywords:
...
> Дополнительные сведения о манифестах развертывания и приложений см. в разделе [Построение приложения WPF](building-a-wpf-application-wpf.md).  
 ...
 Эти файлы создаются при построении XBAP. Дополнительные сведения см. в разделе [Практическое руководство. Создание нового проекта приложения обозревателя WPF](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/bb628663(v=vs.100)). Как и страницы только с разметкой [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] , XBAP обычно публикуются на веб-сервере и просматриваются с помощью Internet Explorer.  
