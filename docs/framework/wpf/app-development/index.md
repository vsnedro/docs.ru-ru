...
## <a name="windows-and-dialog-boxes"></a>Окна и диалоговые окна  
 Пользователи взаимодействуют с автономными приложениями WPF через Windows. Предназначением окна является размещение содержимого приложения и предоставление функциональных возможностей приложения, которые обычно позволяют пользователям взаимодействовать с содержимым. В WPF эти окна инкапсулированы <xref:System.Windows.Window> классом, который поддерживает:  
...
## <a name="navigation"></a>Навигация  
 WPF поддерживает навигацию в стиле Интернета с помощью страниц ( <xref:System.Windows.Controls.Page> ) и гиперссылок ( <xref:System.Windows.Documents.Hyperlink> ). Навигация может быть реализована разнообразными способами, включая следующие:  
...
- Страницы, размещенные в кадре ( <xref:System.Windows.Controls.Frame> ), который может размещаться на отдельной странице, или на странице, скомпилированной в XBAP или в автономное приложение.  
  
 Для упрощения навигации в WPF реализованы следующие возможности:  
  
- <xref:System.Windows.Navigation.NavigationService>, общий механизм навигации для обработки запросов навигации, который используется службами <xref:System.Windows.Controls.Frame> , <xref:System.Windows.Navigation.NavigationWindow> и XBAP для поддержки навигации внутри приложения.  
...
|Заголовок|Описание|  
|-----------|-----------------|  
|[Общие сведения об управлении приложениями](application-management-overview.md)|Общие сведения о классе <xref:System.Windows.Application>, включая управление временем существования приложения, окнами, ресурсами приложений и навигацией.|  
