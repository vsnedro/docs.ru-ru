...
description: Узнайте, как указать источник привязки в этом примере в Windows Presentation Foundation (WPF).
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
