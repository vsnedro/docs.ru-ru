...
## <a name="table-of-collection-types"></a>Таблица типов коллекций

В следующей таблице показаны типы коллекций F #.

|Type|Описание|Связанные ссылки|
|----|-----------|-------------|
...
|Функция|Массив|Список|Sequence|Схема|Задать|Описание|
|--------|-----|----|--------|---|---|-----------|
...
|макс.|O (N)|O (N)|O (N)|-|-|Возвращает наибольший элемент в коллекции по сравнению с использованием оператора [Max](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#max) .|
|максби|O (N)|O (N)|O (N)|-|-|Возвращает наибольший элемент в коллекции, по сравнению с использованием параметра [Max](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#max) в результатах функции.|
|макселемент|-|-|-|-|O (log (N))|Возвращает наибольший элемент в наборе согласно упорядочению, используемому для набора.|
|мин|O (N)|O (N)|O (N)|-|-|Возвращает элемент наименьшего уровня в коллекции по сравнению с использованием оператора [min](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#min) .|
|минби|O (N)|O (N)|O (N)|-|-|Возвращает элемент наименьшего уровня в коллекции по сравнению с использованием оператора [min](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#min) в результатах функции.|
...
|sort|O (n \* журнала (n)) среднее значение<br /><br />O (N ^ 2) наихудший случай|O (n \* log (n))|O (n \* log (n))|-|-|Сортирует коллекцию по значению элемента. Элементы сравниваются с помощью функции [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|sortBy|O (n \* журнала (n)) среднее значение<br /><br />O (N ^ 2) наихудший случай|O (n \* log (n))|O (n \* log (n))|-|-|Сортирует заданный список с помощью ключей, предоставляемых заданной проекцией. Ключи сравниваются с помощью функции [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|сортинплаце|O (n \* журнала (n)) среднее значение<br /><br />O (N ^ 2) наихудший случай|-|-|-|-|Сортирует элементы массива, изменяя его на месте и используя заданную функцию сравнения. Элементы сравниваются с помощью функции [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|сортинплацеби|O (n \* журнала (n)) среднее значение<br /><br />O (N ^ 2) наихудший случай|-|-|-|-|Сортирует элементы массива, изменяя его на месте и используя заданную проекцию для ключей. Элементы сравниваются с помощью функции [Compare](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-operators.html#compare).|
|сортинплацевис|O (n \* журнала (n)) среднее значение<br /><br />O (N ^ 2) наихудший случай|-|-|-|-|Сортирует элементы массива, изменяя его на месте и используя данную функцию сравнения в качестве порядка.|
|сортвис|O (n \* журнала (n)) среднее значение<br /><br />O (N ^ 2) наихудший случай|O (n \* log (n))|-|-|-|Сортирует элементы коллекции, используя заданную функцию сравнения в качестве порядка и возвращая новую коллекцию.|
