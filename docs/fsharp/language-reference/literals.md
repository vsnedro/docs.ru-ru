...
|Decimal|дробное число, представленное в виде фиксированной точки или рационального числа|M или m|`0.7833M` либо `0.7833m`|
|Char|символьный формат Юникода|нет|`'a'` либо `'\u0061'`|
