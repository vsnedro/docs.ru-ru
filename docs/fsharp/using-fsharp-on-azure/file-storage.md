...
Для получения концептуального обзора хранения файлов, пожалуйста, ознакомьтесь [с руководством .NET для хранения файлов.](https://docs.microsoft.com/azure/storage/storage-dotnet-how-to-use-files)
...
Здесь вы получите корневой каталог и получите подкаталог корня. Вы создаете и то, и другое, если они еще не существуют.
