...
Это правило включено по умолчанию только для проектов, предназначенных для .NET 5,0 или более поздней версии. Но вы можете [включить](#configurability) его для проектов, ориентированных на другие платформы.
