...
Это правило срабатывает при выполнении обоих следующих условий для [Newtonsoft.Json.Jsонсериализерсеттингс](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm) инстанк:
