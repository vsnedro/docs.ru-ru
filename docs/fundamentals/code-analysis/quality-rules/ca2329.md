...
Это правило срабатывает, если дляNewtonsoft.Json.Jsинстанк для [ десериализации](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) справедливы оба следующих условия:
