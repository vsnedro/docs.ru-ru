...
- классификация (двоичная и многоклассовая);
- регрессия;
- рекомендация.
- В будущем: другие задачи машинного обучения, такие как классификация изображений, ранжирование, обнаружение аномалий и кластеризация.
...
Ниже приведен список метрик для классификации пяти ведущих моделей в CLI.
