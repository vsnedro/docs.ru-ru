...
Метод `CreatePredictionEngine()` принимает входной и выходной класс данных. Имена полей и/или атрибуты кода определяют имена столбцов данных, которые используются при обучении модели и прогнозировании. Дополнительные сведения см. в статье [Прогнозирование с помощью обученной модели](how-to-guides/machine-learning-model-predictions-ml-net.md).
...
* Если вы полны энтузиазма, то [справочная документация по API](../../api/index.md?view=ml-dotnet) всегда к вашим услугам.
