...
>[!NOTE]
>В рамках стратегии one-vs.-rest обновляется любой [алгоритм обучения двоичной классификации](#binary-classification) для работы с многоклассовыми наборами данных. Подробнее см. в [Википедии](https://en.wikipedia.org/wiki/Multiclass_classification#One-vs.-rest).
