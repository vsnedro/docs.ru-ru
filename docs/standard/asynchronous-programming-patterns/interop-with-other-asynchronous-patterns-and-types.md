...
- В .NET Framework 1.0 появился шаблон <xref:System.IAsyncResult>, также известный как [асинхронная модель программирования (APM)](asynchronous-programming-model-apm.md) или шаблон `Begin/End`.
- В .NET Framework 2.0 была добавлена [асинхронная модель на основе событий (EAP)](event-based-asynchronous-pattern-eap.md).
- В .NET Framework 4 появилась [асинхронная модель на основе задач (TAP)](task-based-asynchronous-pattern-tap.md), которая заменила APM и EAP и предоставила возможность легко строить процедуры миграции с более ранних шаблонов.
