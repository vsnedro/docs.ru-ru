...
### <a name="the-rune-type-as-a-scalar-value"></a>Тип Rune как скалярное значение
...
### <a name="rune-usage-example-changing-letter-case"></a>Пример использования Rune: изменение регистра букв
...
### <a name="other-rune-apis"></a>Другие API-интерфейсы Rune
...
### <a name="example-count-char-rune-and-text-element-instances"></a>Пример: количество char, Rune и экземпляров текстовых элементов
...
### <a name="example-splitting-string-instances"></a>Пример: разделение экземпляров string
