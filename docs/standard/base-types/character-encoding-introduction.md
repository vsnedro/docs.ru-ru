...
Передайте строку Hello этой функции, и вы получите следующие выходные данные:
...
### <a name="the-opno-locrune-type-as-a-scalar-value"></a>Тип Rune как скалярное значение
...
### <a name="opno-locrune-usage-example-changing-letter-case"></a>Пример использования Rune: изменение регистра букв
...
### <a name="other-opno-locrune-apis"></a>Другие API-интерфейсы Rune
...
### <a name="example-count-opno-locchar-opno-locrune-and-text-element-instances"></a>Пример: количество char, Rune и экземпляров текстовых элементов
...
### <a name="example-splitting-opno-locstring-instances"></a>Пример: разделение экземпляров string
