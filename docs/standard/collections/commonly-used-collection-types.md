...
|Заголовок|Описание|  
|-----------|-----------------|  
|[Коллекции и структуры данных](index.md)|Описание различных типов коллекций, доступных в .NET, в том числе стеков, очередей, списков, массивов и словарей.|  
