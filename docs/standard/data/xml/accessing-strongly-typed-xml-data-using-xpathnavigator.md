...
|<xref:System.Xml.XPath.XPathNavigator.ValueAs%2A>|Содержимое узла, приведенное к целевому типу согласно правилам приведения типов XPath 2.0.|  
 ...
 Дополнительные сведения о сопоставлении встроенных типов схемы с типами CLR см. в руководстве по [поддержке типов в классах System.Xml](type-support-in-the-system-xml-classes.md).  
