...
## <a name="string-uri"></a>Строковые URI  
 ...
 См. дополнительные сведения о [разрешении внешних ресурсов в ходе обработки XSLT](resolving-external-resources-during-xslt-processing.md).  
