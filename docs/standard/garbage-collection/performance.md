...
Частоту выделения можно отслеживать с помощью счетчика производительности `Allocated Bytes/second`. Дополнительные сведения см. в статье [Счетчики производительности в .NET](../../framework/debug-trace-profile/performance-counters.md).
