...
Дополнительные сведения о создании файлов ресурсов см. в статье [Создание файлов ресурсов для приложений для настольных систем](../../framework/resources/creating-resource-files-for-desktop-apps.md). Сведения о создании и развертывании вспомогательных сборок см. в статьях [Создание вспомогательных сборок для приложений для настольных систем](../../framework/resources/creating-satellite-assemblies-for-desktop-apps.md) и [Упаковка и развертывание ресурсов в приложениях для настольных систем](../../framework/resources/packaging-and-deploying-resources-in-desktop-apps.md).
...
- Функция [составного форматирования](../base-types/composite-formatting.md), когда она используется с датами.
...
Дополнительные сведения см. в статье [Преобразование времени из одного часового пояса в другой](../datetime/converting-between-time-zones.md).
...
Подробнее см. в статье [Выполнение арифметических операций с датами и временем](../datetime/performing-arithmetic-operations.md).
...
- Функция [составного форматирования](../base-types/composite-formatting.md), когда она используется с числовыми значениями.
