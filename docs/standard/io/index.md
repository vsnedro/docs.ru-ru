...
description: Изучите основы файловых и потоковых операций ввода-вывода, которые представляют собой передачу данных в среду хранения или из нее в .NET.
ms.date: 03/30/2017
...
Соглашения об именовании и способы указания пути к файлу в системах Windows, включая синтаксис устройств DOS, поддерживаемый в .NET Core 1.1 и более поздних версиях и платформе .NET Framework 4.6.2 и более поздних версиях, см. в статье [Форматы путей файлов в системах Windows](file-path-formats.md).
