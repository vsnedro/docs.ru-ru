...
5. Создайте новый сеансовый ключ при помощи класса <xref:System.Security.Cryptography.Aes>.  Этот ключ будет использоваться для шифрования XML-элемента, а затем будет зашифрован и помещен в XML-документ.  
