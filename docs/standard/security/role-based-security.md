...
|Заголовок|Описание|  
|-----------|-----------------|  
|[Объекты Principal и Identity](principal-and-identity-objects.md)|Описываются принципы настройки универсальных удостоверений и субъектов и удостоверений и субъектов Windows, а также управления ими.|  
|[Основные понятия безопасности](key-security-concepts.md)|Основные понятия, с которыми необходимо ознакомиться перед использованием механизмов безопасности .NET Framework.|  
