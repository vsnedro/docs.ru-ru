...
Дополнительные сведения о полиморфной **сериализации** и **десериализации** см. в [этом разделе](system-text-json-migrate-from-newtonsoft-how-to.md#polymorphic-serialization).
