...
description: Узнайте о сериализации XML — базовом механизме передачи, применяемом в архитектуре веб-служб XML. Сериализация XML выполняется классом XmlSerializer.
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
