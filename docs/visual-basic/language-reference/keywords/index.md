...
Следующие ключевые слова являются *зарезервированными*, то есть их нельзя использовать в качестве имен программных элементов, таких как переменные или процедуры. Это ограничение можно обойти, заключив имя в квадратные скобки (`[]`). Дополнительные сведения см. в подразделе "Экранированные имена" раздела [Имена объявляемых элементов](../../programming-guide/language-features/declared-elements/declared-element-names.md).
...
|[`CInt`](../functions/type-conversion-functions.md)|[`Class`Противоречит](../statements/type-list.md)|[`Class`Баланс](../statements/class-statement.md)|[`CLng`](../functions/type-conversion-functions.md)|
...
|[`Each`](../statements/for-each-next-statement.md)|[`Else`](../statements/else-statement.md)|[`ElseIf`](../statements/if-then-else-statement.md)|[`End`Баланс](../statements/end-statement.md)|
...
|[`If`](../statements/if-then-else-statement.md)|[`If()`](../operators/if-operator.md)|[`Implements`](../statements/implements-clause.md)|[`Implements`Баланс](../statements/implements-statement.md)|
|[`Imports`(Пространство имен и тип .NET)](../statements/imports-statement-net-namespace-and-type.md)|[`Imports`(Пространство имен XML)](../statements/imports-statement-xml-namespace.md)|[`In`](../statements/in-clause.md)|[`In`(Универсальный модификатор)](../modifiers/in-generic-modifier.md)|
...
|[`Module`](../modifiers/module-keyword.md)|[`Module`Баланс](../statements/module-statement.md)|[`MustInherit`](../modifiers/mustinherit.md)|[`MustOverride`](../modifiers/mustoverride.md)|
...
|[`Narrowing`](../modifiers/narrowing.md)|[`New`Противоречит](../statements/type-list.md)|[`New`Станции](../operators/new-operator.md)|[`Next`](../statements/for-next-statement.md)|
...
|[`String`](../data-types/string-data-type.md)|[`Structure`Противоречит](../statements/type-list.md)|[`Structure`Баланс](../statements/structure-statement.md)|[`Sub`](../statements/sub-statement.md)|
...
|[`-=`](../operators/subtraction-assignment-operator.md)|[`>>`Станции](../operators/right-shift-operator.md)|[`>>=`Станции](../operators/right-shift-assignment-operator.md)|[<<](../operators/left-shift-operator.md)|
...
|[Data Types Summary](data-types-summary.md)|Содержит список типов данных. Также содержит перечень функций для преобразования и проверки типов данных.|  
...
|[Справочные материалы по My](my-reference.md)|Приводит список объектов, содержащихся в `My`. Этот компонент предоставляет доступ к часто используемым методам, свойствам и событиям компьютера, на котором выполняется приложение, к текущему приложению, ресурсам приложения, параметрам приложения и т. д.|  
|[Сводка по операторам](operators-summary.md)|Содержит список выражений назначения и сравнения и других операторов.|  
