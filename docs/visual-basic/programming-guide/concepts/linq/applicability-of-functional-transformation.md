...
- Документы на основе XML. Имеющие правильный формат данные на любом диалекте языка XML могут быть легко подвергнуты функциональным преобразованиям. Дополнительные сведения см. в разделе [функциональное преобразование XML (Visual Basic)](functional-transformation-of-xml.md).  
...
- [Функциональное преобразование XML (Visual Basic)](functional-transformation-of-xml.md)
