...
ms.locfileid: "84413340"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="d0a44-102">Пример XML-файла. Клиенты и заказы в пространстве имен</span><span class="sxs-lookup"><span data-stu-id="d0a44-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="d0a44-103">Следующий XML-файл используется в различных примерах в документации [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].</span><span class="sxs-lookup"><span data-stu-id="d0a44-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="d0a44-104">Этот файл содержит сведения о заказчиках и заказах.</span><span class="sxs-lookup"><span data-stu-id="d0a44-104">This file contains customers and orders.</span></span> <span data-ttu-id="d0a44-105">XML располагается в пространстве имен.</span><span class="sxs-lookup"><span data-stu-id="d0a44-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="d0a44-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="d0a44-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="d0a44-107">См. также раздел</span><span class="sxs-lookup"><span data-stu-id="d0a44-107">See also</span></span>

- [<span data-ttu-id="d0a44-108">Примеры XML-документов (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="d0a44-108">Sample XML Documents (LINQ to XML)</span></span>](sample-xml-documents-linq-to-xml.md)
