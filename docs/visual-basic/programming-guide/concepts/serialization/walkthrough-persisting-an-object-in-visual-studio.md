...
> [!NOTE]
> В Visual Basic можно использовать объект `My.Settings` для хранения простых данных, таких как имя или число. Дополнительные сведения см. в разделе [Объект My.Settings](../../../language-reference/objects/my-settings-object.md).  
