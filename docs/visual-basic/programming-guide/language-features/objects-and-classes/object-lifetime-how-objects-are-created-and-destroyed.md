...
Конструкторы и деструкторы управляют созданием и уничтожением объектов. `Sub New`Процедуры и `Sub Finalize` в Visual Basic инициализации и уничтожения объектов; они заменяют `Class_Initialize` методы и, `Class_Terminate` используемые в Visual Basic 6,0 и более ранних версиях.
...
- [Инициализация и прекращение работы компонентов](/previous-versions/visualstudio/visual-studio-2013/ws9dc6t6(v=vs.120))
