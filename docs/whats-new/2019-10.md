...
- [Справочные сборки](../standard/assembly/reference-assemblies.md) . раздел "Добавление эталонных сборок"
- [System. IO. конвейеры в .NET](../standard/io/pipelines.md) — документ конвейера —
