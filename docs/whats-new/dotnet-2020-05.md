...
Добро пожаловать в документацию по .NET для 2020 мая. В этой статье перечислены основные изменения, внесенные в документацию в течение этого периода.
...
- [Как локализовать приложение](/dotnet/desktop/wpf/advanced/how-to-localize-an-application) — различные исправления
...
- [пирлук](https://github.com/pirluq) -Pierre-Luc Харви (1)
...
: октокат: хотите внести вклад в документацию по .NET? Ознакомьтесь с нашим [руководством для соавторов](/contribute/dotnet/dotnet-contribute).
