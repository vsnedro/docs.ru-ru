...
---
### <a name="iasyncresultcompletedsynchronously-property-must-be-correct-for-the-resulting-task-to-complete"></a><span data-ttu-id="2b2ae-101">Чтобы результирующая задача завершилась, реализация свойства IAsyncResult.CompletedSynchronously должна быть правильной</span><span class="sxs-lookup"><span data-stu-id="2b2ae-101">IAsyncResult.CompletedSynchronously property must be correct for the resulting task to complete</span></span>

#### <a name="details"></a><span data-ttu-id="2b2ae-102">Подробнее</span><span class="sxs-lookup"><span data-stu-id="2b2ae-102">Details</span></span>

<span data-ttu-id="2b2ae-103">При вызове TaskFactory.FromAsync реализация свойства <xref:System.IAsyncResult.CompletedSynchronously> должна быть правильной, чтобы результирующая задача завершилась.</span><span class="sxs-lookup"><span data-stu-id="2b2ae-103">When calling TaskFactory.FromAsync, the implementation of the <xref:System.IAsyncResult.CompletedSynchronously> property must be correct for the resulting task to complete.</span></span> <span data-ttu-id="2b2ae-104">То есть свойство должно возвращать значение true, если (и только если) реализация завершилась синхронно.</span><span class="sxs-lookup"><span data-stu-id="2b2ae-104">That is, the property must return true if, and only if, the implementation completed synchronously.</span></span> <span data-ttu-id="2b2ae-105">Раньше свойство не проверялось.</span><span class="sxs-lookup"><span data-stu-id="2b2ae-105">Previously, the property was not checked.</span></span>

#### <a name="suggestion"></a><span data-ttu-id="2b2ae-106">Предложение</span><span class="sxs-lookup"><span data-stu-id="2b2ae-106">Suggestion</span></span>

<span data-ttu-id="2b2ae-107">Если реализация <xref:System.IAsyncResult?displayProperty=fullName> правильно возвращает значение true для свойства <xref:System.IAsyncResult.CompletedSynchronously?displayProperty=fullName> только тогда, когда задача завершилась синхронно, нарушения работы не будет.</span><span class="sxs-lookup"><span data-stu-id="2b2ae-107">If <xref:System.IAsyncResult?displayProperty=fullName> implementations correctly return true for the <xref:System.IAsyncResult.CompletedSynchronously?displayProperty=fullName> property only when a task completed synchronously, then no break will be observed.</span></span> <span data-ttu-id="2b2ae-108">Пользователи должны проверять принадлежащие им реализации <xref:System.IAsyncResult?displayProperty=fullName> (если таковые имеются), чтобы убедиться, что они правильно определяют синхронное завершение задачи.</span><span class="sxs-lookup"><span data-stu-id="2b2ae-108">Users should review <xref:System.IAsyncResult?displayProperty=fullName> implementations they own (if any) to ensure that they correctly evaluate whether a task completed synchronously or not.</span></span>

| <span data-ttu-id="2b2ae-109">name</span><span class="sxs-lookup"><span data-stu-id="2b2ae-109">Name</span></span>    | <span data-ttu-id="2b2ae-110">Значение</span><span class="sxs-lookup"><span data-stu-id="2b2ae-110">Value</span></span>       |
|:--------|:------------|
| <span data-ttu-id="2b2ae-111">Область</span><span class="sxs-lookup"><span data-stu-id="2b2ae-111">Scope</span></span>   | <span data-ttu-id="2b2ae-112">Пограничный случай</span><span class="sxs-lookup"><span data-stu-id="2b2ae-112">Edge</span></span>        |
| <span data-ttu-id="2b2ae-113">Version</span><span class="sxs-lookup"><span data-stu-id="2b2ae-113">Version</span></span> | <span data-ttu-id="2b2ae-114">4.5</span><span class="sxs-lookup"><span data-stu-id="2b2ae-114">4.5</span></span>         |
| <span data-ttu-id="2b2ae-115">Type</span><span class="sxs-lookup"><span data-stu-id="2b2ae-115">Type</span></span>    | <span data-ttu-id="2b2ae-116">Изменение целевой платформы</span><span class="sxs-lookup"><span data-stu-id="2b2ae-116">Retargeting</span></span> |

#### <a name="affected-apis"></a><span data-ttu-id="2b2ae-117">Затронутые API</span><span class="sxs-lookup"><span data-stu-id="2b2ae-117">Affected APIs</span></span>
